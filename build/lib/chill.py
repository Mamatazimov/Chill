...
class Utils:
    ...
    def get_project_versions(path: str):
        ...
        for folder in folder_names:
            ...
            version = fernet.decrypt(crypted).decode("utf-8")
    ...
    def save_chill(
        ...
        try:
            ...
            crypted: str = fernet.encrypt(version.encode()).decode("utf-8")
            folder_name: str = "_".join(path_list) + "_" + crypted
            ...
            if is_opposite:
                ...
                project_path = "/".join(list(versions[0].split("_"))[:-1])
